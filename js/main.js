...
function fetchTimedBackground() {
  fetch('https://raw.githubusercontent.com/r4vanan/wallpapers/refs/heads/main/wall.txt')
    ...
    .then(data => {
      ...
      localStorage.setItem('backgroundImage', randomUrl); // Store the selected image URL in local storage
...
function setBackground(url) {
  ...
  document.body.style.backgroundColor = 'rgba(0, 0, 0, 0.9)'; // Add a semi-transparent black overlay
